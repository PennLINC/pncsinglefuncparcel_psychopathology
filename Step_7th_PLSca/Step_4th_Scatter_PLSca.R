...
PredictionFolder = '/Users/zaixucui/Documents/projects/pncSingleFuncParcel_psychopathology/results/PLSca/AtlasLoading';
...
Fig <- Fig +
       ...
       theme_classic() + labs(x = "Functional Topography Score", y = "Clinical Dimension Score") +
       theme(axis.text=element_text(size=30, color='black'), axis.title=element_text(size=30)) +
       scale_y_continuous(limits = c(-6, 23), breaks = c(-5, 0, 5, 10, 15, 20)) +
       scale_x_continuous(limits = c(-45, 48), breaks = c(-40, -20, 0, 20, 40))
Fig

ggsave('/Users/zaixucui/Dropbox/Paper_Writing_Postdoc/pncSingleParcellation_Psychopathology_PLSR/Figures/Figure7_PLSca/PLSca_Comp1.tiff', width = 17, height = 15, dpi = 600, units = "cm");
