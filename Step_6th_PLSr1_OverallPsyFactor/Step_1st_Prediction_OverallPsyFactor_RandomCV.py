...
OverallPsyFactor = Psychopathology_Mat['overall_psychopathology_4factorv2'];
...
ResultantFolder = AtlasLoading_Folder + '/OverallPsyFactor_All_RegressCovariates_RandomCV';
PLSr1_CZ_Random_RegressCovariates.PLSr1_KFold_RandomCV_MultiTimes(SubjectsData, OverallPsyFactor, Covariates, FoldQuantity, ComponentNumber_Range, 101, ResultantFolder, Parallel_Quantity, 0, 'all.q')
