...
#  coord_flip() +
  expand_limits(x = 4)
g
ggsave('/Users/zaixucui/Dropbox/Paper_Writing_Postdoc/pncSingleParcellation_Psychopathology_PLSR/Figures/Figure8_OtherFactors/Corr_RandomCV_Violin_FearFactor.png', width = 17, height = 15, dpi = 600, units = "cm");
