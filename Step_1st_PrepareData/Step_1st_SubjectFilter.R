...
#########################################################
DemograBehaviorFolder = '/cbica/projects/GURLAB/projects/pncSingleFuncParcel_psycho/data/processedData/DemograBehavior';
# Health Status
...
write.csv(subjid_df, "/cbica/projects/GURLAB/projects/pncSingleFuncParcel_psycho/data/pncSingleFuncParcelPsychopatho_n790_SubjectsIDs.csv", row.names=FALSE)
