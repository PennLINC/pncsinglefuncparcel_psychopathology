...
Folder = [ProjectFolder '/results/SingleParcellation/SingleAtlas_Analysis'];
...
SystemName = {'Motor 1', 'Visual 1', 'Motor 2', 'DA 1', 'DM 1', ...
              'VA 1', 'DM 2', 'Visual 2', 'FP 1', 'FP 2', 'DM 2', ...
              'Motor 3', 'FP 3', 'Auditory', 'VA 2', 'Motor 4', 'DA 2'};
ColorPlate = {'158 186 204', '137 63 153', '73 143 191', '65 171 93', ...
              '242 139 168', '217 117 242', '226 57 93', '102 5 122', ...
              '244 197 115', '216 144 72', '170 12 61', '33 113 181', ...
              '204 109 14', '78 49 168', '206 28 249', '7 69 132', ...
              '0 109 44'};
for i = 1:17
