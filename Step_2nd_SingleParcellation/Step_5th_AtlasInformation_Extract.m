...
SingleAtlasFolder = [ProjectFolder '/results/SingleParcellation/SingleParcel_1by1'];
ResultantFolder = [ProjectFolder '/results/SingleParcellation/SingleAtlas_Analysis'];
