...
ColorScheme = c("#7499C2", "#AF33AD", "#7499C2", "#00A131", "#E76178",
		"#E443FF", "#E76178", "#AF33AD", "#F5BA2E", "#F5BA2E",
		"#E76178", "#7499C2", "#F5BA2E", "#4E31A8", "#E443FF",
		"#7499C2", "#00A131");
ColorScheme_XText = c("#AF33AD", "#AF33AD", "#7499C2", "#7499C2", "#7499C2",
		"#00A131", "#F5BA2E", "#4E31A8", "#7499C2", "#E76178",
		"#E76178", "#E443FF", "#E443FF", "#E76178", "#00A131",
		"#F5BA2E", "#F5BA2E");
Order = c(8, 2, 16, 3, 12, 17, 10, 14, 1, 11, 7, 15, 6, 5, 4, 9, 13);
...
ggplot(AllData, aes(x = Label, y = Variability, fill = Label, color = Label)) +
      ...
      scale_x_discrete(
            limits = c(8, 2, 16, 3, 12, 17, 10, 14, 1, 11, 7, 15, 6, 5, 4, 9, 13),
            labels = c("14", "2", "9", "16", "15", "13", "11", "5", "8", "7",
		       "10", "4", "17", "12", "3", "1", "6")) +
