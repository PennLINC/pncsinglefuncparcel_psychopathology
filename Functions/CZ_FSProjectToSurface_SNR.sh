...
export FREESURFER_HOME="/cbica/projects/GURLAB/projects/pncSingleFuncParcel_psycho/freesurfer/6.0.0"
...
for i in ${hemi[@]}; do
  ...
  mri_vol2surf --mov ${ImagePath} --reg ${targDir}/${BBLID_Str}/coreg/fs_ep2struct_fsl.dat --hemi ${i} --o ${targDir}/${BBLID_Str}/surf/${i}.sm6.residualised.mgh --projfrac 0.5 --interp trilinear --noreshape --surf-fwhm 6 >> ${targDir}/${BBLID_Str}/surf/${BBLID_Str}_projection.log 2>&1
