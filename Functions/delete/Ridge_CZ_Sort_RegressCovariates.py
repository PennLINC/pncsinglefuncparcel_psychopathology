...
def Ridge_KFold_Sort_Permutation(Subjects_Data, Subjects_Score, Covariates, Times_IDRange, Fold_Quantity, Alpha_Range, ResultantFolder, Parallel_Quantity, Max_Queued, Queue, Permutation_RandIndex_File_List=''):
    ...
    for i in np.arange(len(Times_IDRange)):
        ...
        if not os.path.exists(ResultantFolder_I + '/Res_NFold.mat'):
            ...
            system_cmd = 'python3 -c ' + '\'import sys;\
                ...
                Ridge_KFold_Sort_Permutation_Sub(Subjects_Data_Mat_Path[0], Subjects_Score[0], Covariates, Fold_Quantity[0][0], Alpha_Range[0], ResultantFolder_I[0], Parallel_Quantity[0][0], Permutation_RandIndex_File)\' ';
...
def Ridge_KFold_Sort_Permutation_Sub(Subjects_Data_Mat_Path, Subjects_Score, Covariates, Fold_Quantity, Alpha_Range, ResultantFolder, Parallel_Quantity, Permutation_RandIndex_File=''):
    data = sio.loadmat(Subjects_Data_Mat_Path)
    Subjects_Data = data['Subjects_Data']
    Ridge_KFold_Sort(Subjects_Data, Subjects_Score, Covariates, Fold_Quantity, Alpha_Range, ResultantFolder, Parallel_Quantity, 1, Permutation_RandIndex_File);

def Ridge_KFold_Sort(Subjects_Data, Subjects_Score, Covariates, Fold_Quantity, Alpha_Range, ResultantFolder, Parallel_Quantity, Permutation_Flag, Permutation_RandIndex_File=''):
