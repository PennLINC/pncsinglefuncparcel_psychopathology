...
Prediction_Res = readMat(paste0(PredictionFolder, '/ExternalizingCorrtraits_All_RegressCovariates_RandomCV/2Fold_RandomCV_Corr_MAE_Actual_Externalizing.mat'));
Corr_Actual = Prediction_Res$Corr.Externalizing.Actual;

# Find median value
MedianIndex = which(Corr_Actual == median(Corr_Actual));
MedianFolder = paste0(PredictionFolder, '/ExternalizingCorrtraits_All_RegressCovariates_RandomCV/Time_', 
...
Fig
ggsave('/Users/zaixucui/Dropbox/Paper_Writing_Postdoc/pncSingleParcellation_Psychopathology_PLSR/Figures/Figure3_PredictionAccuracy/ExternalizingPrediction_CorrACC.tiff', width = 17, height = 15, dpi = 600, units = "cm");
